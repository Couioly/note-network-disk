...
![](./images/file-20251119163037766.png)

5）再次回到 `文件与链接` 选项，将 `内部链接类型` 修改为 `基于当前笔记的相对路径` 即可。

![](./images/file-20251119163037771.png)

6）现在当存在附件时，它将自动以设置的格式进行配置，如下图：

![](./images/file-20251119163037770.png)
...
![](./images/file-20251119163037777.png)

![](./images/file-20251119163037773.png)
