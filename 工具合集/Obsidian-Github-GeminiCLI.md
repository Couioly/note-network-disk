...
![](./assets/Obsidian-Github-GeminiCLI/file-20251119163037767.png)

2）继续找到 `第三方插件` 选项，点击 `关闭安全模式` 按钮，点击社区插件市场的 `浏览` 按钮；

![](./assets/Obsidian-Github-GeminiCLI/file-20251119163037769.png)

3）在搜索栏中搜索插件 `Custom Attachment Localtion`，点击插件进入后进行 `安装` 和 `启动`；

![](./assets/Obsidian-Github-GeminiCLI/file-20251119163037768.png)
...
![](./assets/Obsidian-Github-GeminiCLI/file-20251119163037766.png)

5）再次回到 `文件与链接` 选项，将 `内部链接类型` 修改为 `基于当前笔记的相对路径` 即可。

![](./assets/Obsidian-Github-GeminiCLI/file-20251119163037771.png)

6）现在当存在附件时，它将自动以设置的格式进行配置，如下图：

![](./assets/Obsidian-Github-GeminiCLI/file-20251119163037770.png)
...
![](./assets/Obsidian-Github-GeminiCLI/file-20251119163037777.png)

![](./assets/Obsidian-Github-GeminiCLI/file-20251119163037773.png)
...
![](./assets/Obsidian-Github-GeminiCLI/file-20251119163037779.png)

4）安装成功后输入 `gemini` 启动Gemini CLI，选择 `Login with Google` 登录海外环境；

![](./assets/Obsidian-Github-GeminiCLI/file-20251119163037778.png)
